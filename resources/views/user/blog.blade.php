...
@section('hero')
    <h1>Inspirasi & Informasi Terbaru dari Pondok Pesantren Assalam</h1>
    <h2>“Temukan artikel menarik seputar kegiatan, panduan islami, dan inspirasi dari santri kami.”</h2>
@endsection
