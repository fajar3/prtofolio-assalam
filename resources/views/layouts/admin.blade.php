...
<head>
    ...
    <title> @yield('title') Admin PP Assalam</title>
...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{$url=='articles'?'active':''}}">
                        <a href="{{url('admin/articles')}}"> <i class="menu-icon fa fa-newspaper-o"></i>Informasi Terkini</a>
                    </li>
                    <li class="{{$url=='destinations'?'active':''}}">
                        <a href="{{url('admin/destinations')}}"><i class="menu-icon fa fa-paper-plane-o"></i>Produk Santri</a>
                    </li>
                    <li class="{{$url=='abouts'?'active':''}}">
                        <a href="{{url('admin/abouts')}}"><i class="menu-icon fa fa-user"></i>Tentang</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div class="footer-inner bg-white">
        <div class="row">
            <div class="col-sm-6">
                &copy; {{ date('Y') }} PP ASSALAM
            </div>
            <div class="col-sm-6 text-right">
                ruqqnofearss <a href="https://unira.ac.id">KKN T16 UNIRAMALANG</a>
            </div>
        </div>
    </div>
</footer>
